      ...
      <div className="col-md-6">
        <div className="card card-profile">
          ...
          <div className="card-body">
            <h3 className="card-title">Créer un compte</h3>
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <input type="mail" className="form-control" placeholder="Nom" />
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-12">
                        <div className="form-group">
                        <input type="mail" className="form-control" placeholder="Prénom" />
                        </div>
                    </div>
                </div>
                <div className="row">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="form-group">
                        <input type="mail" className="form-control" placeholder="Mot de passe" />
                        </div>
                    </div>
                </div>
                <div className="row">
            ...
            <a href="javascript:;" className="btn btn-primary btn-round">Créer</a>
